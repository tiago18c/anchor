...
check out the
[CHANGELOG](https://github.com/solana-foundation/anchor/blob/v0.30.0/CHANGELOG.md#0300---2024-04-15).
...
1. Update `avm`:
   ...
   ```sh
   cargo install --git https://github.com/solana-foundation/anchor --tag v0.30.0 avm --locked
   ```
...
[this](https://github.com/solana-foundation/anchor/pull/2824) if you'd like to learn
more.
...
[this](https://github.com/solana-foundation/anchor/blob/v0.30.0/tests/declare-program/programs/declare-program/src/lib.rs)
...
[Here](https://github.com/solana-foundation/anchor/blob/v0.30.0/tests/spl/token-extensions/programs/token-extensions/src/instructions.rs)
...
`@solana-foundation/anchor` can result in unexpected behavior. In this release, you'll
...
[here](https://github.com/solana-foundation/anchor/blob/v0.30.0/ts/packages/anchor/src/idl.ts).
