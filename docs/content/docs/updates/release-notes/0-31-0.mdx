...
[CHANGELOG](https://github.com/solana-foundation/anchor/blob/v0.31.0/CHANGELOG.md#0310---2025-03-08).
...
[#2955](https://github.com/solana-foundation/anchor/issues/2955),
[#3113](https://github.com/solana-foundation/anchor/issues/3113), and
[#3196](https://github.com/solana-foundation/anchor/issues/3196).
...
frame ([#2939](https://github.com/solana-foundation/anchor/pull/2939)).
...
issue in [solana-foundation/anchor](https://github.com/solana-foundation/anchor/issues/3097).
...
See
[example](https://github.com/solana-foundation/anchor/blob/v0.31.0/tests/custom-discriminator/programs/custom-discriminator/src/lib.rs).
...
- Compilation errors related to incorrectly adding `derive`s and `repr`s to type
  aliases ([#3504](https://github.com/solana-foundation/anchor/pull/3504))
...
See [solana-foundation/anchor#3216](https://github.com/solana-foundation/anchor/pull/3216) for
more information.
...
[`build_idl`](https://github.com/solana-foundation/anchor/blob/v0.31.0/idl/src/build.rs#L119)
...
- A bug where using tuple parameters in instructions would result in an
  incorrect IDL ([#3294](https://github.com/solana-foundation/anchor/pull/3294))
...
[`tokio` example](https://github.com/solana-foundation/anchor/blob/v0.31.0/client/example/src/nonblocking.rs#L65-L99).
