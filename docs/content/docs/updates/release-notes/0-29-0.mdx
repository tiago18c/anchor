...
Anchor keeps a
[CHANGELOG](https://github.com/solana-foundation/anchor/blob/master/CHANGELOG.md) but
...
1. Update `avm`:
   ...
   ```sh
   cargo install --git https://github.com/solana-foundation/anchor --tag v0.29.0 avm --locked
   ```
...
- `anchor_version` requires
  [`avm`](https://github.com/solana-foundation/anchor/tree/master/avm) to be installed.
...
```sh
cargo install --git https://github.com/solana-foundation/anchor --rev 6cf200493a307c01487c7b492b4893e0d6f6cb23 anchor-cli --locked
```
...
- Even though most of it works great, some parts are still rough around the
  ...
  [create an issue](https://github.com/solana-foundation/anchor/issues) if you run into
  a problem.
...
properly with
`idl-build`([#2640](https://github.com/solana-foundation/anchor/issues/2640)).
...
[binary size](https://github.com/solana-foundation/anchor/blob/master/bench/BINARY_SIZE.md#0290)
which is reduced ~36% compared to `0.28.0`!

Similar benchmarks can be found for
[compute units](https://github.com/solana-foundation/anchor/blob/master/bench/COMPUTE_UNITS.md#0290)
and
[stack memory](https://github.com/solana-foundation/anchor/blob/master/bench/STACK_MEMORY.md#0290).
...
[CHANGELOG](https://github.com/solana-foundation/anchor/blob/master/CHANGELOG.md#0290---2023-10-16).
