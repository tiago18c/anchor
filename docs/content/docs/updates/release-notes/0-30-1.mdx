...
[this](https://github.com/solana-foundation/anchor/pull/2946) if you'd like to see the
problem in more detail.

### New spec crate

Making changes to the IDL crate, e.g. adding features such as the
[`convert`](https://github.com/solana-foundation/anchor/pull/2986) feature, would
...
[Here](https://github.com/solana-foundation/anchor/blob/cc43e67399ad50cf7d33466f7bcd7e6dcee88ae2/ts/packages/spl-token/program/lib.rs)
...
[`@solana-foundation/anchor-errors`](https://www.npmjs.com/package/@solana-foundation/anchor-errors).

---

See the full list of notable changes in the
[CHANGELOG](https://github.com/solana-foundation/anchor/blob/v0.30.1/CHANGELOG.md#0301---2024-06-20).
