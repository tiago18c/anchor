...
- If you installed the version `1.0.1`, run `avm use 1.0.1`.
...
```shell title="Terminal"
cargo install --git https://github.com/solana-foundation/anchor --tag v1.0.1 anchor-cli
```
...
[test validator](https://docs.anza.xyz/cli/examples/test-validator)
